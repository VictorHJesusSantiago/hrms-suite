"""Recurso de experiencia: Event Subscription."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = EventSubscriptionRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> EventSubscriptionRecord:
    record = EventSubscriptionRecord(normalize_payload(payload))
    record.validate()
    return record
