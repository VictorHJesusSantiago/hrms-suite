"""Recurso de experiencia: Journey Stage."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = JourneyStageRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> JourneyStageRecord:
    record = JourneyStageRecord(normalize_payload(payload))
    record.validate()
    return record
