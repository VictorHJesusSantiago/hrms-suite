"""Recurso de experiencia: Time Window."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = TimeWindowRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> TimeWindowRecord:
    record = TimeWindowRecord(normalize_payload(payload))
    record.validate()
    return record
