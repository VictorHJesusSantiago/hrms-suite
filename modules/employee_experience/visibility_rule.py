"""Recurso de experiencia: Visibility Rule."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = VisibilityRuleRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> VisibilityRuleRecord:
    record = VisibilityRuleRecord(normalize_payload(payload))
    record.validate()
    return record
