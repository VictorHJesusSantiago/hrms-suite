"""Recurso de experiencia: Engagement Score."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = EngagementScoreRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> EngagementScoreRecord:
    record = EngagementScoreRecord(normalize_payload(payload))
    record.validate()
    return record
