...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = BelongingIndicatorRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> BelongingIndicatorRecord:
    record = BelongingIndicatorRecord(normalize_payload(payload))
    record.validate()
    return record
