"""Recurso de experiencia: Service Level."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = ServiceLevelRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> ServiceLevelRecord:
    record = ServiceLevelRecord(normalize_payload(payload))
    record.validate()
    return record
