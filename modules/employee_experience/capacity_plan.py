"""Recurso de experiencia: Capacity Plan."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = CapacityPlanRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> CapacityPlanRecord:
    record = CapacityPlanRecord(normalize_payload(payload))
    record.validate()
    return record
