"""Recurso de experiencia: Priority Rule."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = PriorityRuleRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> PriorityRuleRecord:
    record = PriorityRuleRecord(normalize_payload(payload))
    record.validate()
    return record
