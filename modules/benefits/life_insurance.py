"""Recurso de beneficios: Life Insurance."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = LifeInsuranceRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> LifeInsuranceRecord:
    record = LifeInsuranceRecord(normalize_payload(payload))
    record.validate()
    return record
