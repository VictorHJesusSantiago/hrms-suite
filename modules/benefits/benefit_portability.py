...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = BenefitPortabilityRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> BenefitPortabilityRecord:
    record = BenefitPortabilityRecord(normalize_payload(payload))
    record.validate()
    return record
