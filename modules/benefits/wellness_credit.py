...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = WellnessCreditRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> WellnessCreditRecord:
    record = WellnessCreditRecord(normalize_payload(payload))
    record.validate()
    return record
