...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OnboardingFormRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OnboardingFormRecord:
    record = OnboardingFormRecord(normalize_payload(payload))
    record.validate()
    return record
