"""Recurso de onboarding: Onboarding Survey."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OnboardingSurveyRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OnboardingSurveyRecord:
    record = OnboardingSurveyRecord(normalize_payload(payload))
    record.validate()
    return record
