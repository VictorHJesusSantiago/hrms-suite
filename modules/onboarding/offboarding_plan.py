...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OffboardingPlanRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OffboardingPlanRecord:
    record = OffboardingPlanRecord(normalize_payload(payload))
    record.validate()
    return record
