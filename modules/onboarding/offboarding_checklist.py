"""Recurso de onboarding: Offboarding Checklist."""
...
@dataclass
class OffboardingChecklistRecord:
    data: dict[str, Any]
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OffboardingChecklistRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OffboardingChecklistRecord:
    record = OffboardingChecklistRecord(normalize_payload(payload))
    record.validate()
    return record
