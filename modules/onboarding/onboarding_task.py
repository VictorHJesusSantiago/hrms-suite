"""Recurso de onboarding: Onboarding Task."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OnboardingTaskRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OnboardingTaskRecord:
    record = OnboardingTaskRecord(normalize_payload(payload))
    record.validate()
    return record
