"""Recurso de onboarding: Equipment Request."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = EquipmentRequestRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> EquipmentRequestRecord:
    record = EquipmentRequestRecord(normalize_payload(payload))
    record.validate()
    return record
