...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = ProbationCheckinRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> ProbationCheckinRecord:
    record = ProbationCheckinRecord(normalize_payload(payload))
    record.validate()
    return record
