"""Recurso de onboarding: Onboarding Plan."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = OnboardingPlanRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> OnboardingPlanRecord:
    record = OnboardingPlanRecord(normalize_payload(payload))
    record.validate()
    return record
