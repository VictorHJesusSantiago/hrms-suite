"""Recurso de remuneracao: Total Rewards."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = TotalRewardsRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> TotalRewardsRecord:
    record = TotalRewardsRecord(normalize_payload(payload))
    record.validate()
    return record
