"""Recurso de remuneracao: Salary History."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = SalaryHistoryRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> SalaryHistoryRecord:
    record = SalaryHistoryRecord(normalize_payload(payload))
    record.validate()
    return record
