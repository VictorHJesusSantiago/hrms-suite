...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = BonusAwardRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> BonusAwardRecord:
    record = BonusAwardRecord(normalize_payload(payload))
    record.validate()
    return record
