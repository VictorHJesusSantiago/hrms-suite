"""Recurso de remuneracao: Commission Plan."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = CommissionPlanRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> CommissionPlanRecord:
    record = CommissionPlanRecord(normalize_payload(payload))
    record.validate()
    return record
