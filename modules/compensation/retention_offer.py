"""Recurso de remuneracao: Retention Offer."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = RetentionOfferRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> RetentionOfferRecord:
    record = RetentionOfferRecord(normalize_payload(payload))
    record.validate()
    return record
