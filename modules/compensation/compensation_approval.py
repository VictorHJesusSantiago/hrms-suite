...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = CompensationApprovalRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> CompensationApprovalRecord:
    record = CompensationApprovalRecord(normalize_payload(payload))
    record.validate()
    return record
