...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = CompaRatioRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> CompaRatioRecord:
    record = CompaRatioRecord(normalize_payload(payload))
    record.validate()
    return record
