...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = PayrollCalendarRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> PayrollCalendarRecord:
    record = PayrollCalendarRecord(normalize_payload(payload))
    record.validate()
    return record
