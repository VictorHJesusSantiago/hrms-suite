...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = RetroactiveAdjustmentRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> RetroactiveAdjustmentRecord:
    record = RetroactiveAdjustmentRecord(normalize_payload(payload))
    record.validate()
    return record
