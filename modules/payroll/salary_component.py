"""Recurso de folha: Salary Component."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = SalaryComponentRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> SalaryComponentRecord:
    record = SalaryComponentRecord(normalize_payload(payload))
    record.validate()
    return record
