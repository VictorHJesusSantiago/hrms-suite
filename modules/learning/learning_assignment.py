"""Recurso de lms: Learning Assignment."""
...
@dataclass
class LearningAssignmentRecord:
    data: dict[str, Any]
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = LearningAssignmentRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> LearningAssignmentRecord:
    record = LearningAssignmentRecord(normalize_payload(payload))
    record.validate()
    return record
