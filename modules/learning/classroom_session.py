"""Recurso de lms: Classroom Session."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = ClassroomSessionRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> ClassroomSessionRecord:
    record = ClassroomSessionRecord(normalize_payload(payload))
    record.validate()
    return record
