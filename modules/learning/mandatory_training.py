"""Recurso de lms: Mandatory Training."""
...
def validate(payload: dict[str, Any]) -> dict[str, Any]:
    record = MandatoryTrainingRecord(normalize_payload(payload))
    record.validate()
    return record.to_dict()

def create(payload: dict[str, Any]) -> MandatoryTrainingRecord:
    record = MandatoryTrainingRecord(normalize_payload(payload))
    record.validate()
    return record
